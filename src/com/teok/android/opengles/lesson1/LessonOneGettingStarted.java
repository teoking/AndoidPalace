...
public class LessonOneGettingStarted extends Activity {
    ...
    public class LessonOneRenderer implements GLSurfaceView.Renderer {
        ...
        private static final String TAG = "LessonOneRenderer";
        /**
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config) {
            ...
            if (vertexShaderHandle != 0)
            {
                ...
                {
                    // Debug
                    String errorMsg = GLES20.glGetShaderInfoLog(vertexShaderHandle);
                    ULog.d(TAG, "vertext shader compile error : " + errorMsg);
            ...
            if (fragmentShaderHandle != 0)
            {
                ...
                {
                    // Debug
                    String errorMsg = GLES20.glGetShaderInfoLog(fragmentShaderHandle);
                    ULog.d(TAG, "fragment shader compile error : " + errorMsg);
